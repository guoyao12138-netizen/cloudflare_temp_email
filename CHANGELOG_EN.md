...
- feat: |Android| Add new Android client app (`android-vertex-ai/`) — sign in with Google OAuth 2.0 and chat with Gemini models in your own Vertex AI project using your GCP identity, equivalent to ADC on mobile
